...
* [PhaserEditor2D-v3-core](https://github.com/PhaserEditor2D/PhaserEditor2D-v3-core): Is the heart of Phaser Editor 2D. Contains the IDE (client) and the native backend. It's code is not public.
